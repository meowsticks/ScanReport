...
//   • Caveat two-tone wordmark (Aggarwal Kamikazes = black, Cutting & Coring
//     Ltd. = red)            • no "Bottom line" callout (more room for data)
//   • footer = page number only, bottom-right
//   • subtle No-go row tint in the findings table (emphasis option 3)
...
const FONTS = '/tmp/node_modules/@fontsource/caveat/files';
const caveat400 = b64(`${FONTS}/caveat-latin-400-normal.woff2`);
const caveat700 = b64(`${FONTS}/caveat-latin-700-normal.woff2`);
...
const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .lh img{height:78px;width:auto}
  .lh .nm1{font-family:'Caveat',cursive;font-weight:700;font-size:34pt;line-height:.82;color:var(--ink)}
  .lh .nm2{font-family:'Caveat',cursive;font-weight:700;font-size:22pt;line-height:.9;color:var(--red)}
  ...
  .scard{border:1px solid #cfcfcf;border-radius:4px;overflow:hidden;page-break-inside:avoid;margin-bottom:6px}
